...
import { FieldLayout } from "@/components/ui/FormV2";
...
export const FieldSelectionFormV2 = () => {
  ...
  return (
    ...
    >
      <form.AppField
        ...
        children={(field) => (
          <FieldLayout>
            <field.FieldLabel htmlFor="">Field selection</field.FieldLabel>
            {options.map((option) => (
              <div className="flex items-center gap-2" key={option.id}>
                ...
                />
                <Label
                  className="font-normal data-[error=true]:text-destructive"
