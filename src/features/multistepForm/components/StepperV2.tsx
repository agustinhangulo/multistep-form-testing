  ...
  return (
    <div className="flex gap-3">
      <StepperLink
        ...
        current={location.pathname === "/form-builder/v2/purpose"}
      >
        <Info className="size-4" />
        Basic information
      </StepperLink>
      <StepperLink
        to="/form-builder/v2/data-source"
        disabled={formName === undefined || formDescription === undefined}
        current={location.pathname === "/form-builder/v2/data-source"}
      >
        <Database className="size-4" />
        Data source
      </StepperLink>
      <StepperLink
        to="/form-builder/v2/field-selection"
        disabled={
          formName === undefined ||
        ...
        current={location.pathname === "/form-builder/v2/field-selection"}
      >
